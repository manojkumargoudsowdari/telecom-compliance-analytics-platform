...
| `category_share` | Page 1, Page 2, Page 3, Page 4 | issue concentration charts, method mix views, share tables, geography share comparisons |
...
- `category_share` depends on the approved active category axis and
  filtered-context denominator rule
